		...
		\subsection{Fully Connected}
			...
			\begin{figure}
				\begin{subfigure}{.49\textwidth}
					\centering
					%\includegraphics[width=0.8*\linewidth]{images/ReLU.png}
					\missingfigure[figwidth=0.5*\linewidth]{Picture depicting ReLU}
					\subcaption{Rectified Linear Unit}
					\label{ReLU}
				\end{subfigure}
				\begin{subfigure}{.49\textheight}
					\centering
					%\include{width=.8\linewidth}{images/ELU.png}
					\missingfigure[figwidth=0.5*\linewidth]{Picture depicting ELU}
